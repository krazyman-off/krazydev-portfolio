# KrazyDev — KrazyMan_off aka Sasha

> Cybersécurité & Développement — 2023-2026

## Projets

### 1. Krazy Studio Bot
- **Status:** Maintenu (2023-2026) - **Repo:** confidentiel (privé)
- **Stack:** Python 3.13 / discord.py 2.7 / SQLite WAL (globality.db + temp.db) / Matplotlib
- **Features:** Tickets V2, Anti-raid, TempVoc, Sondages 20 options, Automod, Logs, Niveaux, Economie, Forensics
